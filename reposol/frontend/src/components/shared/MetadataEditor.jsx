...
export function MetadataEditor({
  ...
  return (
    <div className="metadata-editor" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      {/* 7b. Audit Actions */}
      <div className="metadata-section" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderLeft: '4px solid var(--color-warning)', borderRadius: 'var(--radius-md)', boxShadow: 'var(--shadow-sm)', overflow: 'hidden' }}>
        <div
        ...
        {expandedSections.actions && (
          <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {!readOnly && (
              <button type="button" className="btn-secondary btn-sm" onClick={handleAddAction}>➕ Add Audit Action</button>
            )}
          </div>
        )}
      </div>
