...
Before writing or modifying any code in the `reposol/` directory, you MUST activate and follow the workflow defined in the [doc_first_development](skills/doc_first_development/SKILL.md) skill:
